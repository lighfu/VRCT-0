...
mapping = {
    ...
    "/get/data/selectable_ai_cli_effort_list": {"status": True, "variable":controller.getSelectableAiCliEffortList},
    "/get/data/selected_ai_cli_effort": {"status": True, "variable":controller.getSelectedAiCliEffort},
    "/set/data/selected_ai_cli_effort": {"status": True, "variable":controller.setSelectedAiCliEffort},
    "/get/data/ai_cli_fast_mode_available": {"status": True, "variable":controller.getAiCliFastModeAvailable},
    "/get/data/ai_cli_fast_mode": {"status": True, "variable":controller.getAiCliFastMode},
    "/set/enable/ai_cli_fast_mode": {"status": True, "variable":controller.setEnableAiCliFastMode},
    "/set/disable/ai_cli_fast_mode": {"status": True, "variable":controller.setDisableAiCliFastMode},
