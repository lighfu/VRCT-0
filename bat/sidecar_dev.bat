...
REM dev sidecar launches the selected venv directly (.venv).
...
if errorlevel 1 exit /b 1
echo VRCT dev-fast placeholder; production builds must run build.bat.> src-tauri\bin\_internal\.vrct-dev-placeholder
if errorlevel 1 exit /b 1
